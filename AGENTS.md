...
This project is indexed by GitNexus as **safe-claude-sbx** (1335 symbols, 4916 relationships, 117 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
